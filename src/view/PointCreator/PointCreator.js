...
import DestinationSectionView from './DestinationSectionView.js';
import OffersSectionView from './OffersSectionView.js';
...
export default class PointCreator {
  ...
  getElement() {
    if (!this.element) {
      ...
      if (this.offers) {
        render(new OffersSectionView(), sectionContainer);
      }
      if (this.destination) {
        render(new DestinationSectionView(), sectionContainer);
      }
    }
